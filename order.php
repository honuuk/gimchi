...
if(isset($_GET['pid']) && isset($_GET['num'])&&isset($_GET['unit']))
{
	$p_id = $_GET['pid'];
	$num = $_GET['num'];
	$unit=$_GET['unit'];
...
?>
	...
	<form id="frmOrder" name="frmOrder" action="<?php echo $_SERVER['PHP_SELF'].'?pid='.$p_id.'&num='.$num.'&unit='.$unit; ?>" method="post" >
		<div id="container">
			<div id="content">
				<div class="contents">
											...
											<tbody>
												<tr>
													...
													<td style="text-align:left;">
															...
															<input class="txt-field" style="width:160px;" type="text" name="username" value="<?php echo $user_name; ?>" maxlength="20" />
												...
												<tr>
													...
													<td style="text-align:left;">
															...
															<input class="txt-field hs" style="width:160px; type="text" id="phoneNum" name="userphone" value="<?php echo $user_phone; ?>" maxlength="20"style="background-color:red;"/>
												...
												<tr>
													...
													<td style="text-align:left;">
															...
															<input class="txt-field hs" style="width:80%" type="text" id="mobileNum" name="useraddress"value="<?php echo $user_address; ?>" />
