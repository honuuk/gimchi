...
<div id="box">
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
	  ...
	  <div class="container">
	    ...
	    <input type="text" value="" placeholder="아이디를 입력하시오" name="id" required>

	    <label for="password"><b>비밀번호</b></label>
	    <input type="password" placeholder="비밀번호를 입력하시오" name="password" required>
	  ...
	  <div class="container" style="background-color:#f1f1f1">
			...
			<button id="join" type="button" ><a href="./join.php"> 회원가입</a></button>
