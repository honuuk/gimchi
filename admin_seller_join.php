    					...
    					<table border="0" summary="">
    						...
    						<tbody>
    							<tr>
    								<th scope="row">ID</th>
    								<td>
											<input id="name" class="txtfield" name="userid"  type="text"  />
    								</td>
    							</tr>
									<tr>
    							...
    							<tr>
    								<th scope="row">이름</th>
    								<td>
    									<input id="passwd_confirm" class="txtfield" name="username" type="text"  /> <span id="pwConfirmMsg"></span>
    								</td>
    							</tr>
    							<tr>
    								<th scope="row" id="nameTitle">전화번호</th>
    								<td>
    									<input id="name" class="txtfield" name="userphone"  type="text"  />
    								</td>
    							</tr>
            			<tr>
            				<th scope="row">입금은행</th>
            				<td><input id="address" class="txtfield" type="text" name="userbank" ></td>
            			</tr>
            			<tr>
            				<th scope="row">계좌번호</th>
            				<td><input id="address" class="txtfield" type="text" name="useraccount" ></td>
            			</tr>
    						</tbody>
    					</table>
    				</div>
