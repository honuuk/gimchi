					...
					<table border="0" summary="">
						...
						<tbody>
							<tr>
								<th scope="row">아이디</th>
								<td>
									<input id="member_id" class="txtfield" name="id" placeholder="영문 소문자/숫자, 4~16자" value="" type="text"  /> <span id="idMsg"></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input id="name" class="txtfield" name="name" value="" type="text"  />
								</td>
							</tr>
							<tr class="">
								<th scope="row">주소</th>
								<td>
									<input id="address" class="txtfield" name="address" placeholder="" value="" type="text"  />
								</td>
							</tr>
							<tr class="">
